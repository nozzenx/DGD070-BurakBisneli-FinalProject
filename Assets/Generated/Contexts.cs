...
public partial class Contexts : Entitas.IContexts {
    ...
    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { config, game, gameState, ınput }; } }
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithEntityId(this GameContext context, int Value) {
        return ((Entitas.EntityIndex<GameEntity, int>)context.GetEntityIndex(Contexts.EntityId)).GetEntities(Value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
